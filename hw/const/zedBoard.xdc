...
# Audio Codec - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN AB1 [get_ports {ac_reclrc}];  # "AC-ADR0"
set_property PACKAGE_PIN Y5  [get_ports {ac_muten}];  # "AC-ADR1"
set_property PACKAGE_PIN Y8  [get_ports {ac_recdat}];  # "AC-GPIO0"
set_property PACKAGE_PIN AA7 [get_ports {ac_pbdat}];  # "AC-GPIO1"
set_property PACKAGE_PIN AA6 [get_ports {ac_bclk}];  # "AC-GPIO2"
set_property PACKAGE_PIN Y6  [get_ports {ac_pblrc}];  # "AC-GPIO3"
set_property PACKAGE_PIN AB2 [get_ports {ac_mclk}];  # "AC-MCLK"
set_property PACKAGE_PIN AB4 [get_ports {ac_scl}];  # "AC-SCK"
...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN P16 [get_ports {reset_pb}];  # "BTNC"

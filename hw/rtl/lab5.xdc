...
set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports { uart_tx }]; #IO_L18N_T2_34 Sch=je[2]  je[1]                     
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { uart_rx }]; #IO_25_35 Sch=je[3]       je[2]                          

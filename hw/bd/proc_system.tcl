...
################################################################
# This is a generated script based on design: proc_system1
#
...
# source proc_system1_script.tcl
...
user.org:user:customPeripheral:1.0\
...
proc create_root_design { parentCell } {
  ...
  set DDS_config [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 DDS_config ]
  ...
  set Tuner [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 Tuner ]
  ...
  # Create instance: DDS_config, and set properties
  set DDS_config [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 DDS_config ]
  set_property -dict [ list \
   CONFIG.C_ALL_OUTPUTS {1} \
 ] $DDS_config

  # Create instance: Tuner, and set properties
  set Tuner [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 Tuner ]
  set_property -dict [ list \
   CONFIG.C_ALL_OUTPUTS {1} \
 ] $Tuner

  # Create instance: customPeripheral_0, and set properties
  set customPeripheral_0 [ create_bd_cell -type ip -vlnv user.org:user:customPeripheral:1.0 customPeripheral_0 ]
  ...
  connect_bd_intf_net -intf_net S00_AXIS_0_1 [get_bd_intf_ports S00_AXIS_0] [get_bd_intf_pins customPeripheral_0/S00_AXIS]
  connect_bd_intf_net -intf_net S00_AXI_1 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins ps7_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net Tuner_GPIO [get_bd_intf_ports Tuner] [get_bd_intf_pins Tuner/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports gpio_rtl_0] [get_bd_intf_pins gpio/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO1 [get_bd_intf_ports DDS_config] [get_bd_intf_pins DDS_config/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO2 [get_bd_intf_ports gpio_rtl_1] [get_bd_intf_pins gpio/GPIO2]
  connect_bd_intf_net -intf_net axi_iic_0_IIC [get_bd_intf_ports iic_rtl_0] [get_bd_intf_pins iic/IIC]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M01_AXI [get_bd_intf_pins iic/S_AXI] [get_bd_intf_pins ps7_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M02_AXI [get_bd_intf_pins gpio/S_AXI] [get_bd_intf_pins ps7_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M03_AXI [get_bd_intf_pins DDS_config/S_AXI] [get_bd_intf_pins ps7_axi_periph/M03_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M04_AXI [get_bd_intf_pins Tuner/S_AXI] [get_bd_intf_pins ps7_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net ps7_axi_periph_M00_AXI [get_bd_intf_pins customPeripheral_0/S00_AXI] [get_bd_intf_pins ps7_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net M_AXI_GP0_ACLK_0_1 [get_bd_ports Clk] [get_bd_pins DDS_config/s_axi_aclk] [get_bd_pins Tuner/s_axi_aclk] [get_bd_pins customPeripheral_0/s00_axi_aclk] [get_bd_pins customPeripheral_0/s00_axis_aclk] [get_bd_pins gpio/s_axi_aclk] [get_bd_pins iic/s_axi_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_axi_periph/ACLK] [get_bd_pins ps7_axi_periph/M00_ACLK] [get_bd_pins ps7_axi_periph/M01_ACLK] [get_bd_pins ps7_axi_periph/M02_ACLK] [get_bd_pins ps7_axi_periph/M03_ACLK] [get_bd_pins ps7_axi_periph/M04_ACLK] [get_bd_pins ps7_axi_periph/S00_ACLK]
  connect_bd_net -net reset_rtl_0_1 [get_bd_ports reset_rtl_0] [get_bd_pins proc_sys_reset_0/ext_reset_in]
  connect_bd_net -net rst_Clk_100M_peripheral_aresetn [get_bd_pins DDS_config/s_axi_aresetn] [get_bd_pins Tuner/s_axi_aresetn] [get_bd_pins customPeripheral_0/s00_axi_aresetn] [get_bd_pins customPeripheral_0/s00_axis_aresetn] [get_bd_pins gpio/s_axi_aresetn] [get_bd_pins iic/s_axi_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins ps7_axi_periph/ARESETN] [get_bd_pins ps7_axi_periph/M00_ARESETN] [get_bd_pins ps7_axi_periph/M01_ARESETN] [get_bd_pins ps7_axi_periph/M02_ARESETN] [get_bd_pins ps7_axi_periph/M03_ARESETN] [get_bd_pins ps7_axi_periph/M04_ARESETN] [get_bd_pins ps7_axi_periph/S00_ARESETN]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x41200000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs DDS_config/S_AXI/Reg] SEG_DDS_config_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41210000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Tuner/S_AXI/Reg] SEG_Tuner_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs customPeripheral_0/S00_AXI/S00_AXI_reg] SEG_customPeripheral_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41220000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs gpio/S_AXI/Reg] SEG_gpio_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41600000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs iic/S_AXI/Reg] SEG_iic_Reg
